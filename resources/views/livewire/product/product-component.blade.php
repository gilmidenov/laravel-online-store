                ...
                <nav class="breadcrumbs">
                    <ul>
                        ...
                        @foreach($breadcrumbs as $breadcrumbs_slug => $breadcrumbs_title)
                            <li>
                                <a href="{{ route('category', $breadcrumbs_slug) }}" wire:navigate>
                                    {{ $breadcrumbs_title }}
                                </a>
                            </li>
                        @endforeach
                ...
                <div class="bg-white product-content p-3 h-100">
                    ...
                    <div class="product-add2cart">
                        <div class="input-group">
                            ...
                            <button class="btn btn-warning" wire:click="addToCart({{ $product->id }}, true)" wire:loading.attr="disabled">
                            ...
                            <div class="tab-pane fade" id="features-tab-pane" role="tabpanel"
                                ...
                                <table class="table">
                                    ...
                                    @foreach($attributes as $k => $attribute)
                                        <tr>
                                            <th scope="row" wire:key="{{ $k }}">{{ $attribute->filter_groups_title }} </th>
